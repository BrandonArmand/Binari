...
import useGetContributors from "./components/useGetContributors";
...
export default function About() {
    ...
    const { contributors } = useGetContributors(url);
    return (
        <div>
            <div
                className={
                ...
                <div className={classes.container}>
                    <GridContainer justify="flex-start">
                        ...
                        <GridItem xs={12} sm={12} md={12}>
                            ...
                            <h2 className={classes.subtitle}>
                                Binari&apos;s mission is to provide the best
                                experience for new developers through an easy to
                                use code-editor and data-structure visualizer.
                                The problem with learning a new algorithm or
                                data-structure tends to lie in understanding how
                                the data/code gets organized. I am here to fix
                                that, and you are welcome to join.
                            </h2>
                        </GridItem>
                    </GridContainer>
                    ...
                    <GridContainer justify="flex-start">
                        <GridItem xs={12} sm={12} md={12}>
                            ...
                            <h2 className={classes.subtitle}>
                                There are a list of issues on Github that you
                                are welcome to work on. If you have an idea of
                                your own, we are open to allowing any pull
                                requests we believe fit well with Binari&apos;s
                                vision.
                            </h2>
