...
# Insertion
## Fundamentals
We begin from the root node.
- Compare the new value with the value of the root node. If the new value is lesser than that of the root, we move to the left subtree.
